...
namespace RhythmVerseClient.Models
{
    ...
    public partial class RootResponse
    {
        public static RootResponse FromJson(string json) => JsonSerializer.Deserialize<RootResponse>(json, RhythmVerseClient.Models.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this RootResponse self) => JsonSerializer.Serialize(self, RhythmVerseClient.Models.Converter.Settings);
    }
