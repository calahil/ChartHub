    ...
    private static AppConfigRoot Clone(AppConfigRoot source)
    {
        return new AppConfigRoot
        {
            ...
            Runtime = new RuntimeAppConfig
            {
                ...
                SyncApiPairCodeTtlMinutes = source.Runtime.SyncApiPairCodeTtlMinutes,
                SyncApiLastPairedDeviceLabel = source.Runtime.SyncApiLastPairedDeviceLabel,
                ...
                SyncApiMutationWaitTimeoutMs = source.Runtime.SyncApiMutationWaitTimeoutMs,
                SyncApiSlowRequestThresholdMs = source.Runtime.SyncApiSlowRequestThresholdMs,
