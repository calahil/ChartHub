...
public class ApiClientService : INotifyPropertyChanged
{
    ...
    private readonly Dictionary<string, List<string>> _gameFormatMetadata = new()
    {
    ...
    private static bool IsMockDataEnabled(IConfiguration configuration)
    {
        ...
        {
            if (bool.TryParse(candidate, out bool enabled) && enabled)
            {
                return true;
            }
    ...
    private int GiveMeRatingsNow(Song song, string instrument)
    {
        int dataRating;
        int fileRating;
        DataData data = song.Data.DataData;
        FileData file = song.File;
            ...
            case "drums":
                if (data != null)
                {
                    if (data.DiffDrums.HasValue &&
                                         ...
                                         data.DiffDrums.Value < _ratings.Count)
                    {
                ...
                if (file.DiffDrums.HasValue &&
                    ...
                    file.DiffDrums.Value < _ratings.Count)
                {
            ...
            case "guitar":
                if (data != null)
                {
                    if (data.DiffGuitar.HasValue &&
                                         ...
                                         data.DiffGuitar.Value < _ratings.Count)
                    {
                ...
                if (file.DiffGuitar.HasValue &&
                    ...
                    file.DiffGuitar.Value < _ratings.Count)
                {
            ...
            case "bass":
                if (data != null)
                {
                    if (data.DiffBass.HasValue &&
                                         ...
                                         data.DiffBass.Value < _ratings.Count)
                    {
                ...
                if (file.DiffBass.HasValue &&
                    ...
                    file.DiffBass.Value < _ratings.Count)
                {
            ...
            case "vocals":
                if (data != null)
                {
                    if (data.DiffVocals.HasValue &&
                                         ...
                                         data.DiffVocals.Value < _ratings.Count)
                    {
                ...
                if (file.DiffVocals.HasValue &&
                    ...
                    file.DiffVocals.Value < _ratings.Count)
                {
            ...
            case "keys":
                if (data != null)
                {
                    if (data.DiffKeys.HasValue &&
                                         ...
                                         data.DiffKeys.Value < _ratings.Count)
                    {
                ...
                if (file.DiffKeys.HasValue &&
                    ...
                    file.DiffKeys.Value < _ratings.Count)
                {
