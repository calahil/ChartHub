...
#nullable enable
// Intentional suppressions retained for generated/deserialized API model code.
// The model is populated by JSON deserialization and intentionally allows null-shape
// transitions that static flow analysis cannot reliably infer across converter paths.
...
public partial class RootResponse
{
    public static RootResponse FromJson(string json) => JsonSerializer.Deserialize<RootResponse>(json, ChartHub.Models.Converter.Settings);
}

public static class Serialize
{
    public static string ToJson(this RootResponse self) => JsonSerializer.Serialize(self, ChartHub.Models.Converter.Settings);
}
    ...
    public override DataUnion Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        switch (reader.TokenType)
        {
            ...
            case JsonTokenType.StartObject:
                DataData? objectValue = JsonSerializer.Deserialize<DataData>(ref reader, options);
    ...
    public override AltVersions Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        switch (reader.TokenType)
        {
            ...
            case JsonTokenType.StartArray:
                List<AltVersion>? arrayValue = JsonSerializer.Deserialize<List<AltVersion>>(ref reader, options);
...
internal class CreditsUnionConverter : JsonConverter<CreditsUnion>
{
    ...
    public override CreditsUnion Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        {
            case JsonTokenType.StartObject:
                CreditsClass? objectValue = JsonSerializer.Deserialize<CreditsClass>(ref reader, options);
                return new CreditsUnion { CreditsClass = objectValue };
            case JsonTokenType.StartArray:
                List<object>? arrayValue = JsonSerializer.Deserialize<List<object>>(ref reader, options);
