...
public class ApiClientServiceTests
{
    ...
    public async Task GetSongFilesAsync_WhenMockDataUnavailable_FallsBackToLiveApi_AndMapsFileFields()
    {
        ...
        Assert.Equal("avares://RhythmVerseClient/Resources/Images/noalbumart.png", song.AlbumArt);
        Assert.Equal("avares://RhythmVerseClient/Resources/Images/blankprofile.png", song.Author?.AvatarPath);
    ...
    public class ApiClientServiceParsingTests
    {
      ...
      public void JsonParsing_VerifyFileDownloadsField()
      {
        ...
        var r = RhythmVerseClient.Models.RootResponse.FromJson(json);
