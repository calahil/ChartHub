...
public class MainViewModelTests
{
    ...
    public void ObserveBackgroundTask_WhenTaskFaults_LogsFailure()
    {
        lock (LoggerSync)
        {
            ...
            var logPath = Path.Combine(temp.RootPath, "rhythmverseclient.log");
    ...
    private sealed class FakeGoogleDriveClient(string rhythmVerseFolderId) : IGoogleDriveClient
    {
        public string RhythmVerseFolderId { get; } = rhythmVerseFolderId;
